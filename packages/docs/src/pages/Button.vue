...
<template>
  ...
  <section>
    ...
    <McButton type="primary" @click="handleClick" size="small">
      主要按钮
    </McButton>
    <McButton type="success" @click="handleClick" size="default"
      >成功按钮</McButton
    >
  ...
  <section>
    ...
    <McButton type="primary" @click="handleClick" plain>
      <template #before-icon>
        <div class="i-ic-baseline-insert-emoticon"></div>
      </template>
      图标按钮
    ...
    <McButton type="success" @click="handleClick" plain>
      <template #before-icon>
        <div class="i-ic-baseline-insert-emoticon"></div>
      </template>
      图标按钮
    ...
    <McButton type="danger" @click="handleClick" plain>
      <template #after-icon>
        <div class="i-ic-baseline-insert-emoticon"></div>
      </template>
      图标按钮
